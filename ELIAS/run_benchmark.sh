...
accelerate launch --config_file configs/accelerate.yaml --num_processes ${num_gpus} train.py configs/${dataset}/elias-1.yaml --num_epochs 5
...
accelerate launch --config_file configs/accelerate.yaml --num_processes ${num_gpus} elias_utils.py gen_cluster_A Results/${project}/${dataset}/ELIAS-1/config.yaml
