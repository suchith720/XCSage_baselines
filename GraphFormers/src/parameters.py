...
def parse_args():
    ...
    parser.add_argument("--mode", type=str, default="train", choices=['train', 'test', 'test_xc'])
    ...
    parser.add_argument("--multi_world_size", type=int, default=8)
    ...
    parser.add_argument('--graph_lbl_x_y', type=str,
                        help='Path to graph_lbl_x_y.')
    parser.add_argument('--lbl_raw_text', type=str,
                        help='Path to lbl_raw_text.')
    parser.add_argument('--graph_raw_text', type=str,
                        help='Path to graph_raw_text.')

    parser.add_argument('--tst_raw_text', type=str,
                        help='Path to tst_raw_text.')
    parser.add_argument('--tst_x_y', type=str,
                        help='Path to tst_X_Y.')
